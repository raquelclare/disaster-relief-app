...
export default class Org26 extends Component {
  ...
  handleClick() {
    var url = 'https://lwr.org/donate/where-needed-most';
      ...
      return (
        <View style={styles.container}>
          ...
          <View style={styles.header}>
            <Text style={styles.title}>Lutheran World Relief</Text>
          </View>
          <ScrollView>
          <Image
          ...
          <View style={{flexDirection: 'row', justifyContent: 'space-around', marginTop: 10}}>
            ...
            <View style={styles.infoTextContainer}>
              <Text style={styles.bigInfoText}>1945</Text>
          ...
          <Text style={styles.text}>Mission: Affirming God’s love for all people, the Lutheran World Relief (LWR) works with Lutherans and partners around the world to end poverty, injustice, and human suffering.</Text>

           <Text style={styles.text}>Vision: Empowered by God’s unconditional love in Jesus Christ, LWR envisions a world in which each person, every community, and all generations live in justice, dignity, and peace.</Text> 

           <Text style={styles.text}>The LWR’s values are grounded in gratitude, calling, accompaniment, stewardship, and innovation. With 100 local partners, LWR works to improve harvests, health, and education in some 35 countries each year. LWR partners train women and men to produce local foods, dig low-cost wells, and protect and restore their local environments.</Text>       

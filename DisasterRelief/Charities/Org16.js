...
import orgImg from '../img/all-hands.jpeg';

export default class Org16 extends Component {
  ...
  handleClick() {
    var url = 'https://give.hands.org/checkout/donation?eid=42579&amount=&recurring=0';

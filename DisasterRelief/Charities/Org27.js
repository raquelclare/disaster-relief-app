...
export default class Org27 extends Component {
  ...
  handleClick() {
    var url = 'https://donate.pih.org/give-today';
      ...
      return (
        <View style={styles.container}>
          ...
          <View style={styles.header}>
            <Text style={styles.title}>Partners in Health</Text>
          </View>
          <ScrollView>
          <Image
          ...
          <Text style={styles.text}>Mission: To provide a preferential option for the poor in health care.</Text>

          <Text style={styles.text}>Whether to Liberia, Rwanda, or any of the countries we work and live, Partners in Health goes where they’re needed most.</Text>

          <Text style={styles.text}>They care for patients in their homes and communities. They work in close partnership with local government officials and the world’s leading medical and academic institutions to build capacity and strengthen health systems. And they stay, committed to accompanying the people and communities they serve for the long term.</Text>

          <Text style={styles.text}>By establishing long-term relationships with sister organizations based in settings of poverty, Partners In Health strives to achieve two overarching goals: to bring the benefits of modern medical science to those most in need of them and to serve as an antidote to despair. They draw on the resources of the world’s leading medical and academic institutions and on the lived experience of the world’s poorest and sickest communities.</Text> 

          <Text style={styles.text}>At its root, their mission is both medical and moral. It is based on solidarity, rather than charity alone. When patients are ill and have no access to care, their team of health professionals, scholars, and activists will do whatever it takes to make them well.</Text>       
